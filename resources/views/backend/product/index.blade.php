                ...
                <div class="box-body">
                    <form action="" method="GET" id="filter-form">
                        <div class="row d-flex align-items-bottom">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <button type="button" id="reset-btn" class="btn btn-info"
                ...
                <div class="box-header with-border">
                    ...
                    <div class="box-tools pull-right">
                        <button type="button" class="btn btn-sm btn-primary rounded-0"
                            onclick="showFormModal('New Product', 'Save')"><i class="fa fa-plus fa-sm"></i> Add
                            Product</button>
                    </div>
                </div>
                <div class="box-body">
                    ...
                    if (data.status == false) {
                        $.each(data.errors, function(key, value) {
                            ...
                            $('#store_or_update_form #' + key).parent().append(
                                '<small class="text-danger d-block error">' + value +
                                '</small>');
                        });
                    } else {
